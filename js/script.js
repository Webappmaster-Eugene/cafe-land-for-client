...
// ---------------------modal
    ...
    const modalBtn = document.querySelector('.main__button-link')
    ...
    modal.addEventListener('click', (e) => {
        if(e.target == document.querySelector('.modal') || e.target == document.querySelector('.form__inner') || e.target.getAttribute('data-close') == ''){
            closeModal()
        }
    })
